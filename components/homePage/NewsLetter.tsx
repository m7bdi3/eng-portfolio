...
export const NewsLetter = () => {
  return (
    <div className="relative h-full my-12 w-full ">
      <div className="w-full">
        <div className="grid items-center">
          <p className="inline-block text-sm font-medium bg-clip-text text-primary text-center">
            A vision for 2024
          </p>
          <div className="mt-4 md:mb-12 text-center">
            <h1 className="mb-4 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
              Cloud Unleashed: Your Future in the Sky
            </h1>
            <p className="text-xl text-muted-foreground">
              Experience limitless possibilities with our cutting-edge
              Architicture solutions.
            </p>
          </div>
