            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    The Coastal Chic Beach House project aims to create a
                    relaxed, airy living space that captures the essence of
                    beachside living. The design features light, breezy colors,
                    natural materials, and open spaces to enhance the coastal
                    vibe.
                  </p>
                </div>
              </div>
              <div className="mt-6">
                ...
                <ul className="list-disc list-inside">
                  <li>Create a light, airy atmosphere</li>
                  <li>Use coastal-inspired colors and materials</li>
                  <li>Design open, flowing spaces</li>
                  <li>Incorporate large windows to maximize ocean views</li>
                </ul>
              </div>
              <div className="mt-6">
                <h2 className="text-2xl font-semibold text-gray-800 mb-2">
              ...
              <div className="mt-6">
                ...
                <blockquote className="border-l-4 border-primary pl-4 italic text-gray-700">
                  “Our beach house feels like a true coastal retreat thanks to
                  Jane’s incredible design. The light, airy spaces and beautiful
                  ocean views make it our perfect getaway.” - The Thompson
                  Family
                </blockquote>
              </div>
            </motion.div>
